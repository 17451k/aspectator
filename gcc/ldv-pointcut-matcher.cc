...
ldv_match_func (tree t, unsigned int line, ldv_ppk pp_kind)
{
  ...
  ldv_adef_iter_init (&adef_iter, LDV_ADEF_INDEX_FUNC, func->name ? ldv_get_id_name (func->name) : NULL, ldv_compilation ());
...
ldv_match_typedecl (tree t, const char *file_path, ldv_ppk pp_kind)
{
  ...
  ldv_adef_iter_init (&adef_iter, LDV_ADEF_INDEX_TYPE, typedecl->name ? ldv_get_id_name (typedecl->name) : NULL, ldv_compilation ());
...
ldv_match_var (tree t, unsigned int line, ldv_ppk pp_kind)
{
  ...
  ldv_adef_iter_init (&adef_iter, LDV_ADEF_INDEX_VAR, ldv_get_id_name (var->name), ldv_compilation ());
