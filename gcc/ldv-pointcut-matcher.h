...
extern void ldv_ensure_func_type (ldv_i_func_ptr);
extern const char *ldv_get_func_decl (ldv_i_func_ptr);
extern const char *ldv_get_var_decl (ldv_i_var_ptr);
extern const char *ldv_get_typedecl_decl (ldv_i_typedecl_ptr);
